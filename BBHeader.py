...
class BBHeader(BaseHeader.BaseHeader) :
    ...
    def static_init(self) -> None :
        ...
        self.kAddressData.add("B_FID_RVN",      "W_FID_SEQ",            "W_FID_SEQ",            VMSBackupHelper.sizeof.uint8_t)
        self.kAddressData.add("B_FID_NMX",      "B_FID_RVN",            "B_FID_RVN",            VMSBackupHelper.sizeof.uint8_t)
        self.kAddressData.add("W_DID",          "B_FID_NMX",            "B_FID_NMX",            VMSBackupHelper.sizeof.uint16_t, 3)
        self.kAddressData.add("W_DID_NUM",      "W_DID",                None,                   VMSBackupHelper.sizeof.uint16_t)
        self.kAddressData.add("W_DID_SEQ",      "W_DID_NUM",            "W_DID_NUM",            VMSBackupHelper.sizeof.uint16_t)
        self.kAddressData.add("W_DID_RVN",      "W_DID_SEQ",            "W_DID_SEQ",            VMSBackupHelper.sizeof.uint16_t)
        self.kAddressData.add("B_DID_RVN",      "W_DID_SEQ",            "W_DID_SEQ",            VMSBackupHelper.sizeof.uint8_t)
        self.kAddressData.add("B_DID_NMX",      "B_DID_RVN",            "B_DID_RVN",            VMSBackupHelper.sizeof.uint8_t)
        self.kAddressData.add("T_FILENAME",     "B_DID_NMX",            "B_DID_NMX",            VMSBackupHelper.sizeof.int8_t, 128)
